...
*/
		...
		{
			sePolicy = new Button(shell, SWT.PUSH | SWT.CENTER);
			sePolicy.setText("Set Policy To Use");
			sePolicy.setBounds(450, 170, 200, 28);
			sePolicy.addSelectionListener(new SelectionAdapter() {
				public void widgetSelected(SelectionEvent evt) {
					assignSelectPolicy(evt);
				}
			});
		}
	...
	private void assignSelectPolicy(SelectionEvent evt)
	{
