...
/**
 * Created by aristocrat on 12/3/16.
 */
public class ACO_AND_PSO extends AllocPolicy {
    /**
     ...
     * @pre entityName != null
     * @post $none
     * @see GridSim#init(int, Calendar, boolean, String[], String[],
     * String)
     */
    ...
    private ResGridletList phermones;
    private ResGridletList ants;

    protected ACO_AND_PSO(String resName, String entityName) throws Exception {
        ...
        this.phermones = new ResGridletList();
        this.ants = new ResGridletList();
    }
    ...
    public synchronized void gridletCancel(int gridletId, int userId)
    {
        ...
        if (rgl == null)
        {
            System.out.println(super.resName_ +
                    ".ACOANDPSO.gridletCancel(): Cannot find " +
        ...
        {
            System.out.println(super.resName_
                    + ".ACOANDPSO.gridletCancel(): Cannot cancel"
                    + " Gridlet #" + gridletId + " for User #" + userId
    ...
    public synchronized void gridletPause(int gridletId, int userId, boolean ack)
    {
        ...
        if (found >= 0)
        {
            ...
            {
                System.out.println(super.resName_
                        + ".ACOANDPSO.gridletPause(): Cannot pause"
                        + " Gridlet #" + gridletId + " for User #" + userId
            ...
            else
            {
                ...
                System.out.println(super.resName_ +
                        ".ACOANDPSO.gridletPause(): Gridlet #" + gridletId +
        ...
        {
            System.out.println(super.resName_ +
                    ".ACOANDPSO.gridletPause(): Cannot find " +
                    "Gridlet #" + gridletId + " for User #" + userId);
        }
    ...
    public synchronized void gridletMove(int gridletId, int userId, int destId, boolean ack)
    {
        ...
        {
            System.out.println(super.resName_ +
                    ".ACOANDPSO.gridletMove(): Cannot find " +
                    "Gridlet #" + gridletId + " for User #" + userId);
    ...
    public void body()
    {
        ...
        while (super.sim_waiting() > 0)
        {
            ...
            super.sim_get_next(ev);
            System.out.println(super.resName_ +
                    ".ACONADPSO.body(): ignoring internal events");
        }
    }
    ...
    private MIShares getMIShare(double timeSpan, int size)
    {
        ...
        for (ResGridlet ph : phermones){
            for (ResGridlet an : ants)
            {
                System.out.println("Phermones : "+ ph + " " + an );
            }
        }
